...
from ontology_core.semantic_models import Concept, SemanticElement
...
class OntologyPlanner:
    ...
    def plan(self, query: str) -> QueryPlan:
        ...
        concept = _best_concept(normalized_query, self._resolver.list_concepts())
        ...
        requested = matched_properties or tuple(item.semantic for item in bindings)
        if not requested:
            raise UnsupportedQueryPlanError("本体概念缺少可用的属性映射")
